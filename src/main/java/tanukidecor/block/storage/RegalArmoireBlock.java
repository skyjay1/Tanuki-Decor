...
public class RegalArmoireBlock extends HorizontalDoubleBlock implements EntityBlock {
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        if(pPos.equals(getDelegatePos(pState, pPos))) {
            return TDRegistry.BlockEntityReg.REGAL_ARMOIRE.get().create(pPos, pState);
        }
