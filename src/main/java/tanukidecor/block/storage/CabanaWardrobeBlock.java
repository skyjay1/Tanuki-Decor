...
public class CabanaWardrobeBlock extends HorizontalMultiblock implements EntityBlock {
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        if(pPos.equals(getDelegatePos(pState, pPos))) {
            return TDRegistry.BlockEntityReg.CABANA_WARDROBE.get().create(pPos, pState);
        }
