...
public class BlueBookshelfBlock extends HorizontalMultiblock implements EntityBlock {

    public BlueBookshelfBlock(Properties pProperties) {
        super(MultiblockHandler.MULTIBLOCK_2X1X1,
                HorizontalMultiblock.createEWShapeBuilder(BlueBureauBlock.SHAPE_EAST, BlueBureauBlock.SHAPE_WEST),
                pProperties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        if(pPos.equals(getDelegatePos(pState, pPos))) {
            return TDRegistry.BlockEntityReg.BLUE_BOOKSHELF.get().create(pPos, pState);
        }
