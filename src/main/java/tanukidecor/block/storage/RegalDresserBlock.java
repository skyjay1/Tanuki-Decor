...
public class RegalDresserBlock extends HorizontalMultiblock implements EntityBlock {
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        if(pPos.equals(getDelegatePos(pState, pPos))) {
            return TDRegistry.BlockEntityReg.REGAL_DRESSER.get().create(pPos, pState);
        }
