...
public class WoodenBlockDrawersBlock extends HorizontalMultiblock implements EntityBlock {
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        if(pPos.equals(getDelegatePos(pState, pPos))) {
            return TDRegistry.BlockEntityReg.WOODEN_BLOCK_DRAWERS.get().create(pPos, pState);
        }
