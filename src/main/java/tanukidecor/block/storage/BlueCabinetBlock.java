...
public class BlueCabinetBlock extends HorizontalDoubleBlock implements EntityBlock {
    ...
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        if(pPos.equals(getDelegatePos(pState, pPos))) {
            return TDRegistry.BlockEntityReg.BLUE_CABINET.get().create(pPos, pState);
        }
